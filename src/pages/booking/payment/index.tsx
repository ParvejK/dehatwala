  ...
  return (
    <main className="bg-white pb-16 pt-6 sm:pt-8">
      ...
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-8 lg:px-10">
        ...
        {/* ---------- Trust strip ---------- */}
        <section aria-label="Why book with Dehatwala" className="mt-6 rounded-3xl border border-[#e0eafb] bg-white p-5 sm:p-6">
          <ul className="grid gap-5 sm:grid-cols-3 lg:grid-cols-5">
            {TRUST_POINTS.map(({ icon: Icon, title, copy, tone }) => (
              <li key={title} className="flex flex-col items-center gap-2 text-center">
                <span className="grid size-11 place-items-center rounded-full bg-[#f4f8ff]">
