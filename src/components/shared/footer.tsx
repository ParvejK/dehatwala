...
const linkGroups = [
  { title: "Company", links: [["About us", "/about-us"], ["Contact us", "/contact"], ["Media & news", "/blog"], ["Careers", "/jobs"], ["Blog", "/blog"]] },
  { title: "Legal", links: [["Privacy policy", "/privacy-policy"], ["Terms & conditions", "/terms-and-conditions"], ["Cancellation policy", "/cancellation-policy"], ["Refund policy", "/refund-policy"], ["Worker terms", "/terms-and-conditions"]] },
  { title: "For workers", links: [["Join Dehatwala", "/become-a-part-of-dehatwala"], ["Worker registration", "/become-a-part-of-dehatwala"], ["Worker FAQs", "/faqs"], ["Find work opportunities", "/jobs"]] },
  ...
  <footer className="bg-gradient-to-br from-blue-950 via-blue-900 to-blue-700 text-white">
    <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10">
      <div className="grid gap-12 border-b border-white/15 pb-12 lg:grid-cols-[1.3fr_3fr]">
        <div>
          <Link to="/" aria-label="Dehatwala home"><img src={Logo} alt="Dehatwala" className="h-12 w-auto" /></Link>
          <h2 className="mt-5 text-lg font-bold">India’s trusted workforce platform</h2>
          <p className="mt-3 max-w-sm text-sm leading-6 text-blue-100/75">Connecting customers with verified blue-collar workers through a smarter, more dependable workforce platform.</p>
